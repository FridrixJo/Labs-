...
num1 = input("Enter the first num for operations: ")
while re.match(r'^[-0-9]*$', num1) is None:
    print("Error. Try again")
    num1 = input()

num2 = input("Enter the second num for operations: ")
